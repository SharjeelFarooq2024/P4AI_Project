"""
Model Training Module for UNSW-NB15 Classification
====================================================

This module provides modular model training with Random Forest and evaluation.
"""
...
class ModelTrainer:
    ...
    DESIGN DECISIONS:
    -----------------
    1. Random Forest chosen as baseline for:
       - Handles mixed feature types well
       - Robust to outliers (even after preprocessing)
       - Provides feature importance for interpretability
       - No assumption of linear relationships
       
    2. Alternatives considered:
       - XGBoost: Better performance but more hyperparameters
       - SVM: Poor scalability for large datasets
       - Neural Networks: Requires more data tuning
    """
    ...
    def _print_evaluation(self, metrics: Dict, y_test: pd.Series) -> None:
        ...
        print(f"  Normal (0): Precision={report['0']['precision']:.4f}, Recall={report['0']['recall']:.4f}")
        print(f"  Attack (1): Precision={report['1']['precision']:.4f}, Recall={report['1']['recall']:.4f}")
