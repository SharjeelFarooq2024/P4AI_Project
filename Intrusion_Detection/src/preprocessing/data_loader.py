"""load raw and split data with simple validations"""
...
class DataLoader:
    ...
    #     if missing.sum() > 0:
    #         issues.append(f"Found {missing.sum()} total missing values")
    ...
    #     expected_cols = ['label', 'proto', 'service', 'state']
    ...
    #             issues.append(f"Unexpected label values: {unique_labels}")
