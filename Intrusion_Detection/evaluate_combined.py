...
# Ensure local src/ and project root are importable when running from repo root.
...
def main():
    data_path = Path("data/processed_data_mc/combined_raw_split.csv")
    ...
    model_path = Path("saved_models/combined_rf.joblib")
